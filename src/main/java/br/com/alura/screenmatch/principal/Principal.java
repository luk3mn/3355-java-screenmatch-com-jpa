...
//        dadosSeries.add(dados);
    ...
    private void buscarEpisodioPorSerie(){
        ...
        final Optional<Serie> serie = repositorio.findByTituloContainingIgnoreCase(nomeSerie);
    ...
    private void listarSeriesBuscadas() {
        series = repositorio.findAll(); // busca todos os registros no banco
        series.stream()
...
//        List<Serie> seriesPorTempAval = repositorio.findByTotalTemporadasLessThanEqualAndAvaliacaoGreaterThanEqual(numeroTemporadas, avaliacaoMinima);
        List<Serie> seriesPorTempAval = repositorio.seriesPorTemporadaEAValiacao(numeroTemporadas, avaliacaoMinima);
        seriesPorTempAval.forEach(s -> System.out.println("Série: " + s.getTitulo() + " | Avaliação: " + s.getAvaliacao() + " | Temporadas: " + s.getTotalTemporadas()));
    }
